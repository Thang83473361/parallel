...
pub const DOT: AssetIdentifier = 10;
#[allow(non_upper_case_globals)]
pub const xDOT: AssetIdentifier = 11;
pub const KSM: AssetIdentifier = 20;
#[allow(non_upper_case_globals)]
pub const xKSM: AssetIdentifier = 21;
...
impl DataProvider<AssetIdentifier, TimeStampedPrice> for MockDataProvider {
    fn get(asset_id: &AssetIdentifier) -> Option<TimeStampedPrice> {
        match *asset_id {
...
impl DataProviderExtended<AssetIdentifier, TimeStampedPrice> for MockDataProvider {
    fn get_no_op(_key: &AssetIdentifier) -> Option<TimeStampedPrice> {
        None
    }
...
ord_parameter_types! {
    ...
    pub const StakingCurrency: AssetIdentifier = KSM;
    pub const LiquidCurrency: AssetIdentifier = xKSM;
}
pub struct Decimal;
#[allow(non_upper_case_globals)]
...
impl LiquidStakingCurrenciesProvider<AssetIdentifier> for LiquidStaking {
