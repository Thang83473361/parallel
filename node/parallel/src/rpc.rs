...
use primitives::{AccountId, AssetIdentifier, Balance, DataProviderId, Index, TimeStampedPrice};
...
where
    ...
    C::Api:
        orml_oracle_rpc::OracleRuntimeApi<Block, DataProviderId, AssetIdentifier, TimeStampedPrice>,
